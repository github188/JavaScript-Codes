...
function NumberHandler() {
	...
	*/
	this.convertToRomanNumber = function ( number ) {
...
function ArrayHandler( ) {
	 ...
	 */
	this.getMaxAndMinFromArray = function ( __arr ) {
	 ...
	 */
	this.splitArrayToEleInArray = function ( __arr ) {
		// 参数错误
		if ( errorHandler.argumentErrorHandler(__arr) ) return;
	 ...
	 */
	this.sumAllBetweenMinToMaxOfArray = function ( __arr ) {
	 ...
	 */
	this.delEleFromArray = function ( targetArr, element, replaceElement ) {
	 ...
	 * @return {[type]}           [description]
	 */
	this.delFalseEleFromArray = function ( targetArr ) {
		// 参数检查，错误处理
...
function ErrorHandler( ) {
	...
	this.argumentErrorHandler = function ( __args, __type ) {
...
function Tools( ) {
	...
	// 2. 判断是否为对象型数据
	this.isObject = function( __value ) {
